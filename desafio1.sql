...
FOREIGN KEY (usuarios_id1) REFERENCES SpotifyClone.usuarios(id),
	FOREIGN KEY (cancoes_id) REFERENCES SpotifyClone.cancoes(id),
	PRIMARY KEY (usuarios_id1, cancoes_id)
)
ENGINE = InnoDB;
...
INSERT INTO SpotifyClone.cancoes (cancoes, duracao_segundos, albuns_id)
VALUES
  ('Soul For Us', 200, 1),
  ...
  INSERT INTO SpotifyClone.historico_de_reproducoes (
	usuarios_id1, cancoes_id, data_reproducao)
VALUES
